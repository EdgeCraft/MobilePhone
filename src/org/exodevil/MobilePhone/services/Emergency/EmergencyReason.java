...
public class EmergencyReason extends StringPrompt {
	...
	public Prompt acceptInput(ConversationContext context, String s) {
		...
		context.getForWhom().sendRawMessage(ChatColor.GREEN + "[Service] " + "Deine Meldung wurde aufgenommen. Dir wird in Kürze geholfen");
	...
	public void updateDB(int userID, String reason, String problem) throws Exception {
		...
		PreparedStatement updateService = db.prepareStatement("INSERT INTO service_emergency (serviceid, userid, reason, problem) VALUES (?, ?, ?, ?);");
	 ...
	 public int greatestID() throws Exception {
		  List<Map<String, Object>> tempVar = db.getResults("SELECT COUNT(serviceid) AS amount FROM service_emergency");
